...
mixin _$AuthEvent {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(_AuthLogin value) login,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult? Function(_AuthLogin value)? login,
...
/// @nodoc
mixin _$AuthState {
  UIStatusAuth get status => throw _privateConstructorUsedError;
...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({UIStatusAuth status, String error});
}
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl(
      {this.status = UIStatusAuth.loading,
      this.error = 'Something went wrong'});

  @override
  @JsonKey()
  final UIStatusAuth status;
  @override
  @JsonKey()
  final String error;
...
abstract class _Initial implements AuthState {
  const factory _Initial({final UIStatusAuth status, final String error}) =
      _$InitialImpl;

  @override
  UIStatusAuth get status;
  @override
  String get error;
